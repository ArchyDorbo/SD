...
class APIContext:
    def __init__(self, dllHandle):
        ...
        from .sdvaluespotcolor import SDValueSpotColor
        self.SDValueSpotColor_get = self.mDllHandle.SDValueSpotColor_get
        self.SDValueSpotColor_get.restype = ctypes.c_int
        self.SDValueSpotColor_get.argtypes = [ctypes.c_void_p, ctypes.POINTER(ColorRGBA)]
        self.mTypeMap['SDValueSpotColor'] = SDValueSpotColor
        ...
        self.SDPackageMgr_saveCopyOfPackageAs = self.mDllHandle.SDPackageMgr_saveCopyOfPackageAs
        self.SDPackageMgr_saveCopyOfPackageAs.restype = ctypes.c_int
        self.SDPackageMgr_saveCopyOfPackageAs.argtypes = [ctypes.c_void_p, ctypes.c_void_p, ctypes.c_char_p]
        ...
        self.SDResource_delete = self.mDllHandle.SDResource_delete
        self.SDResource_delete.restype = ctypes.c_int
        self.SDResource_delete.argtypes = [ctypes.c_void_p]
        ...
        self.SDPackage_getUID = self.mDllHandle.SDPackage_getUID
        self.SDPackage_getUID.restype = ctypes.c_int
        self.SDPackage_getUID.argtypes = [ctypes.c_void_p, ctypes.POINTER(ctypes.c_char_p)]
        ...
        self.SDPackage_isModified = self.mDllHandle.SDPackage_isModified
        self.SDPackage_isModified.restype = ctypes.c_int
        self.SDPackage_isModified.argtypes = [ctypes.c_void_p, ctypes.POINTER(ctypes.c_bool)]
        ...
        self.SDGraph_deleteGraphObject = self.mDllHandle.SDGraph_deleteGraphObject
        self.SDGraph_deleteGraphObject.restype = ctypes.c_int
        self.SDGraph_deleteGraphObject.argtypes = [ctypes.c_void_p, ctypes.c_void_p]
        ...
        self.SDSBSCompGraph_getUID = self.mDllHandle.SDSBSCompGraph_getUID
        self.SDSBSCompGraph_getUID.restype = ctypes.c_int
        self.SDSBSCompGraph_getUID.argtypes = [ctypes.c_void_p, ctypes.POINTER(ctypes.c_char_p)]
        self.SDSBSCompGraph_getSupportedGraphTypeCount = self.mDllHandle.SDSBSCompGraph_getSupportedGraphTypeCount
        self.SDSBSCompGraph_getSupportedGraphTypeCount.restype = ctypes.c_int
        self.SDSBSCompGraph_getSupportedGraphTypeCount.argtypes = [ctypes.POINTER(ctypes.c_size_t)]
        self.SDSBSCompGraph_getSupportedGraphTypeAt = self.mDllHandle.SDSBSCompGraph_getSupportedGraphTypeAt
        self.SDSBSCompGraph_getSupportedGraphTypeAt.restype = ctypes.c_int
        self.SDSBSCompGraph_getSupportedGraphTypeAt.argtypes = [ctypes.c_size_t, ctypes.POINTER(ctypes.c_char_p)]
        self.SDSBSCompGraph_getGraphType = self.mDllHandle.SDSBSCompGraph_getGraphType
        self.SDSBSCompGraph_getGraphType.restype = ctypes.c_int
        self.SDSBSCompGraph_getGraphType.argtypes = [ctypes.c_void_p, ctypes.POINTER(ctypes.c_char_p)]
        self.SDSBSCompGraph_setGraphType = self.mDllHandle.SDSBSCompGraph_setGraphType
        self.SDSBSCompGraph_setGraphType.restype = ctypes.c_int
        self.SDSBSCompGraph_setGraphType.argtypes = [ctypes.c_void_p, ctypes.c_char_p]
        self.SDSBSCompGraph_getExposedInSBSAR = self.mDllHandle.SDSBSCompGraph_getExposedInSBSAR
        self.SDSBSCompGraph_getExposedInSBSAR.restype = ctypes.c_int
        self.SDSBSCompGraph_getExposedInSBSAR.argtypes = [ctypes.c_void_p, ctypes.POINTER(ctypes.c_bool)]
        self.SDSBSCompGraph_getIcon = self.mDllHandle.SDSBSCompGraph_getIcon
        self.SDSBSCompGraph_getIcon.restype = ctypes.c_int
        self.SDSBSCompGraph_getIcon.argtypes = [ctypes.c_void_p, ctypes.POINTER(ctypes.c_void_p)]
        ...
        self.SDSBSCompGraph_getDefaultParentSize = self.mDllHandle.SDSBSCompGraph_getDefaultParentSize
        self.SDSBSCompGraph_getDefaultParentSize.restype = ctypes.c_int
        self.SDSBSCompGraph_getDefaultParentSize.argtypes = [ctypes.c_void_p, ctypes.POINTER(int2)]
        self.SDSBSCompGraph_setDefaultParentSize = self.mDllHandle.SDSBSCompGraph_setDefaultParentSize
        self.SDSBSCompGraph_setDefaultParentSize.restype = ctypes.c_int
        self.SDSBSCompGraph_setDefaultParentSize.argtypes = [ctypes.c_void_p, ctypes.POINTER(int2)]
        self.SDSBSCompGraph_getPresets = self.mDllHandle.SDSBSCompGraph_getPresets
        self.SDSBSCompGraph_getPresets.restype = ctypes.c_int
        self.SDSBSCompGraph_getPresets.argtypes = [ctypes.c_void_p, ctypes.POINTER(ctypes.c_void_p)]
        self.SDSBSCompGraph_getPreset = self.mDllHandle.SDSBSCompGraph_getPreset
        self.SDSBSCompGraph_getPreset.restype = ctypes.c_int
        self.SDSBSCompGraph_getPreset.argtypes = [ctypes.c_void_p, ctypes.c_char_p, ctypes.POINTER(ctypes.c_void_p)]
        self.SDSBSCompGraph_newPreset = self.mDllHandle.SDSBSCompGraph_newPreset
        self.SDSBSCompGraph_newPreset.restype = ctypes.c_int
        self.SDSBSCompGraph_newPreset.argtypes = [ctypes.c_void_p, ctypes.c_char_p, ctypes.POINTER(ctypes.c_void_p)]
        self.SDSBSCompGraph_deletePreset = self.mDllHandle.SDSBSCompGraph_deletePreset
        self.SDSBSCompGraph_deletePreset.restype = ctypes.c_int
        self.SDSBSCompGraph_deletePreset.argtypes = [ctypes.c_void_p, ctypes.c_char_p]
        self.SDSBSCompGraph_getInputIdentifiers = self.mDllHandle.SDSBSCompGraph_getInputIdentifiers
        self.SDSBSCompGraph_getInputIdentifiers.restype = ctypes.c_int
        self.SDSBSCompGraph_getInputIdentifiers.argtypes = [ctypes.c_void_p, ctypes.POINTER(ctypes.c_void_p)]
        self.SDSBSCompGraph_getOutputIdentifiers = self.mDllHandle.SDSBSCompGraph_getOutputIdentifiers
        self.SDSBSCompGraph_getOutputIdentifiers.restype = ctypes.c_int
        self.SDSBSCompGraph_getOutputIdentifiers.argtypes = [ctypes.c_void_p, ctypes.POINTER(ctypes.c_void_p)]
        self.SDSBSCompGraph_reorderGraphInput = self.mDllHandle.SDSBSCompGraph_reorderGraphInput
        self.SDSBSCompGraph_reorderGraphInput.restype = ctypes.c_int
        self.SDSBSCompGraph_reorderGraphInput.argtypes = [ctypes.c_void_p, ctypes.c_char_p, ctypes.c_int]
        self.SDSBSCompGraph_reorderGraphOutput = self.mDllHandle.SDSBSCompGraph_reorderGraphOutput
        self.SDSBSCompGraph_reorderGraphOutput.restype = ctypes.c_int
        self.SDSBSCompGraph_reorderGraphOutput.argtypes = [ctypes.c_void_p, ctypes.c_char_p, ctypes.c_int]
        ...
        self.SDApplication_getSpotColorLibrary = self.mDllHandle.SDApplication_getSpotColorLibrary
        self.SDApplication_getSpotColorLibrary.restype = ctypes.c_int
        self.SDApplication_getSpotColorLibrary.argtypes = [ctypes.c_void_p, ctypes.POINTER(ctypes.c_void_p)]
        self.SDApplication_getAppInteropMgr = self.mDllHandle.SDApplication_getAppInteropMgr
        self.SDApplication_getAppInteropMgr.restype = ctypes.c_int
        self.SDApplication_getAppInteropMgr.argtypes = [ctypes.c_void_p, ctypes.POINTER(ctypes.c_void_p)]
        self.SDApplication_getVersion = self.mDllHandle.SDApplication_getVersion
        self.SDApplication_getVersion.restype = ctypes.c_int
        self.SDApplication_getVersion.argtypes = [ctypes.c_void_p, ctypes.POINTER(ctypes.c_char_p)]
        ...
        self.SDSBSARExporter_exportSBSFileToSBSAR = self.mDllHandle.SDSBSARExporter_exportSBSFileToSBSAR
        self.SDSBSARExporter_exportSBSFileToSBSAR.restype = ctypes.c_int
        self.SDSBSARExporter_exportSBSFileToSBSAR.argtypes = [ctypes.c_void_p, ctypes.c_char_p, ctypes.c_char_p]
        ...
        self.SDUIMgr_addActionToGraphViewToolbar = self.mDllHandle.SDUIMgr_addActionToGraphViewToolbar
        self.SDUIMgr_addActionToGraphViewToolbar.restype = ctypes.c_int
        self.SDUIMgr_addActionToGraphViewToolbar.argtypes = [ctypes.c_void_p, ctypes.c_size_t, ctypes.c_size_t]
        ...
        self.SDUIMgr_getCurrentGraphSelectedNodes = self.mDllHandle.SDUIMgr_getCurrentGraphSelectedNodes
        self.SDUIMgr_getCurrentGraphSelectedNodes.restype = ctypes.c_int
        self.SDUIMgr_getCurrentGraphSelectedNodes.argtypes = [ctypes.c_void_p, ctypes.POINTER(ctypes.c_void_p)]
        self.SDUIMgr_getCurrentGraphSelectedObjects = self.mDllHandle.SDUIMgr_getCurrentGraphSelectedObjects
        self.SDUIMgr_getCurrentGraphSelectedObjects.restype = ctypes.c_int
        self.SDUIMgr_getCurrentGraphSelectedObjects.argtypes = [ctypes.c_void_p, ctypes.POINTER(ctypes.c_void_p)]
        ...
        self.SDUIMgr_getGraphSelectedNodesFromGraphViewID = self.mDllHandle.SDUIMgr_getGraphSelectedNodesFromGraphViewID
        self.SDUIMgr_getGraphSelectedNodesFromGraphViewID.restype = ctypes.c_int
        self.SDUIMgr_getGraphSelectedNodesFromGraphViewID.argtypes = [ctypes.c_void_p, ctypes.c_size_t, ctypes.POINTER(ctypes.c_void_p)]
        self.SDUIMgr_getGraphSelectedObjectsFromGraphViewID = self.mDllHandle.SDUIMgr_getGraphSelectedObjectsFromGraphViewID
        self.SDUIMgr_getGraphSelectedObjectsFromGraphViewID.restype = ctypes.c_int
        self.SDUIMgr_getGraphSelectedObjectsFromGraphViewID.argtypes = [ctypes.c_void_p, ctypes.c_size_t, ctypes.POINTER(ctypes.c_void_p)]
        ...
        self.SDUIMgr_setExplorerSelection = self.mDllHandle.SDUIMgr_setExplorerSelection
        self.SDUIMgr_setExplorerSelection.restype = ctypes.c_int
        self.SDUIMgr_setExplorerSelection.argtypes = [ctypes.c_void_p, ctypes.c_void_p]
        self.SDUIMgr_convertSDTextureToQImage = self.mDllHandle.SDUIMgr_convertSDTextureToQImage
        self.SDUIMgr_convertSDTextureToQImage.restype = ctypes.c_int
        self.SDUIMgr_convertSDTextureToQImage.argtypes = [ctypes.c_void_p, ctypes.c_size_t]
        self.SDUIMgr_openResourceInEditor = self.mDllHandle.SDUIMgr_openResourceInEditor
        self.SDUIMgr_openResourceInEditor.restype = ctypes.c_int
        self.SDUIMgr_openResourceInEditor.argtypes = [ctypes.c_void_p, ctypes.c_void_p]
        self.SDUIMgr_focusGraphNode = self.mDllHandle.SDUIMgr_focusGraphNode
        self.SDUIMgr_focusGraphNode.restype = ctypes.c_int
        self.SDUIMgr_focusGraphNode.argtypes = [ctypes.c_void_p, ctypes.c_size_t, ctypes.c_void_p]
        self.SDUIMgr_getGraphViewIDCount = self.mDllHandle.SDUIMgr_getGraphViewIDCount
        self.SDUIMgr_getGraphViewIDCount.restype = ctypes.c_int
        self.SDUIMgr_getGraphViewIDCount.argtypes = [ctypes.c_void_p, ctypes.POINTER(ctypes.c_size_t)]
        self.SDUIMgr_getGraphViewIDAt = self.mDllHandle.SDUIMgr_getGraphViewIDAt
        self.SDUIMgr_getGraphViewIDAt.restype = ctypes.c_int
        self.SDUIMgr_getGraphViewIDAt.argtypes = [ctypes.c_void_p, ctypes.c_size_t, ctypes.POINTER(ctypes.c_size_t)]
        ...
        self.SDColorManagementEngine_convertWorkingColorSpaceToDisplayColorSpace = self.mDllHandle.SDColorManagementEngine_convertWorkingColorSpaceToDisplayColorSpace
        self.SDColorManagementEngine_convertWorkingColorSpaceToDisplayColorSpace.restype = ctypes.c_int
        self.SDColorManagementEngine_convertWorkingColorSpaceToDisplayColorSpace.argtypes = [ctypes.c_void_p, ctypes.POINTER(ColorRGB), ctypes.POINTER(ColorRGB)]
        self.SDColorManagementEngine_canConvertLabColorToWorkingColorSpace = self.mDllHandle.SDColorManagementEngine_canConvertLabColorToWorkingColorSpace
        self.SDColorManagementEngine_canConvertLabColorToWorkingColorSpace.restype = ctypes.c_int
        self.SDColorManagementEngine_canConvertLabColorToWorkingColorSpace.argtypes = [ctypes.c_void_p, ctypes.POINTER(ctypes.c_bool)]
        self.SDColorManagementEngine_convertLabColorSpaceToWorkingColorSpace = self.mDllHandle.SDColorManagementEngine_convertLabColorSpaceToWorkingColorSpace
        self.SDColorManagementEngine_convertLabColorSpaceToWorkingColorSpace.restype = ctypes.c_int
        self.SDColorManagementEngine_convertLabColorSpaceToWorkingColorSpace.argtypes = [ctypes.c_void_p, ctypes.POINTER(ColorRGB), ctypes.POINTER(ColorRGB)]
        self.mTypeMap['SDColorManagementEngine'] = SDColorManagementEngine
        from .sdspotcolorlibrary import SDSpotColorLibrary
        self.SDSpotColorLibrary_findSpotColorByName = self.mDllHandle.SDSpotColorLibrary_findSpotColorByName
        self.SDSpotColorLibrary_findSpotColorByName.restype = ctypes.c_int
        self.SDSpotColorLibrary_findSpotColorByName.argtypes = [ctypes.c_void_p, ctypes.c_char_p, ctypes.c_char_p, ctypes.POINTER(ctypes.c_void_p)]
        self.SDSpotColorLibrary_findClosestSpotColor = self.mDllHandle.SDSpotColorLibrary_findClosestSpotColor
        self.SDSpotColorLibrary_findClosestSpotColor.restype = ctypes.c_int
        self.SDSpotColorLibrary_findClosestSpotColor.argtypes = [ctypes.c_void_p, ctypes.c_char_p, ctypes.c_float, ctypes.c_float, ctypes.c_float, ctypes.POINTER(ctypes.c_void_p)]
        self.SDSpotColorLibrary_getSpotColorBookName = self.mDllHandle.SDSpotColorLibrary_getSpotColorBookName
        self.SDSpotColorLibrary_getSpotColorBookName.restype = ctypes.c_int
        self.SDSpotColorLibrary_getSpotColorBookName.argtypes = [ctypes.c_void_p, ctypes.c_void_p, ctypes.POINTER(ctypes.c_char_p)]
        self.SDSpotColorLibrary_getSpotColorName = self.mDllHandle.SDSpotColorLibrary_getSpotColorName
        self.SDSpotColorLibrary_getSpotColorName.restype = ctypes.c_int
        self.SDSpotColorLibrary_getSpotColorName.argtypes = [ctypes.c_void_p, ctypes.c_void_p, ctypes.POINTER(ctypes.c_char_p)]
        self.mTypeMap['SDSpotColorLibrary'] = SDSpotColorLibrary
        from .sbs.sdsbsgraphthumbnailgenerator import SDSBSGraphThumbnailGenerator
        self.SDSBSGraphThumbnailGenerator_sNew = self.mDllHandle.SDSBSGraphThumbnailGenerator_sNew
        self.SDSBSGraphThumbnailGenerator_sNew.restype = ctypes.c_int
        self.SDSBSGraphThumbnailGenerator_sNew.argtypes = [ctypes.POINTER(ctypes.c_void_p)]
        self.SDSBSGraphThumbnailGenerator_generateThumbnail = self.mDllHandle.SDSBSGraphThumbnailGenerator_generateThumbnail
        self.SDSBSGraphThumbnailGenerator_generateThumbnail.restype = ctypes.c_int
        self.SDSBSGraphThumbnailGenerator_generateThumbnail.argtypes = [ctypes.c_void_p, ctypes.c_void_p]
        self.SDSBSGraphThumbnailGenerator_isFinished = self.mDllHandle.SDSBSGraphThumbnailGenerator_isFinished
        self.SDSBSGraphThumbnailGenerator_isFinished.restype = ctypes.c_int
        self.SDSBSGraphThumbnailGenerator_isFinished.argtypes = [ctypes.c_void_p, ctypes.POINTER(ctypes.c_bool)]
        self.SDSBSGraphThumbnailGenerator_cancel = self.mDllHandle.SDSBSGraphThumbnailGenerator_cancel
        self.SDSBSGraphThumbnailGenerator_cancel.restype = ctypes.c_int
        self.SDSBSGraphThumbnailGenerator_cancel.argtypes = [ctypes.c_void_p]
        self.SDSBSGraphThumbnailGenerator_getLastError = self.mDllHandle.SDSBSGraphThumbnailGenerator_getLastError
        self.SDSBSGraphThumbnailGenerator_getLastError.restype = ctypes.c_int
        self.SDSBSGraphThumbnailGenerator_getLastError.argtypes = [ctypes.c_void_p, ctypes.POINTER(ctypes.c_char_p)]
        self.mTypeMap['SDSBSGraphThumbnailGenerator'] = SDSBSGraphThumbnailGenerator
        from .sdappinteropmgr import SDAppInteropMgr
        self.SDAppInteropMgr_isEnabled = self.mDllHandle.SDAppInteropMgr_isEnabled
        self.SDAppInteropMgr_isEnabled.restype = ctypes.c_int
        self.SDAppInteropMgr_isEnabled.argtypes = [ctypes.c_void_p, ctypes.POINTER(ctypes.c_bool)]
        self.SDAppInteropMgr_isSamplerInstalled = self.mDllHandle.SDAppInteropMgr_isSamplerInstalled
        self.SDAppInteropMgr_isSamplerInstalled.restype = ctypes.c_int
        self.SDAppInteropMgr_isSamplerInstalled.argtypes = [ctypes.c_void_p, ctypes.POINTER(ctypes.c_bool)]
        self.SDAppInteropMgr_isPainterInstalled = self.mDllHandle.SDAppInteropMgr_isPainterInstalled
        self.SDAppInteropMgr_isPainterInstalled.restype = ctypes.c_int
        self.SDAppInteropMgr_isPainterInstalled.argtypes = [ctypes.c_void_p, ctypes.POINTER(ctypes.c_bool)]
        self.SDAppInteropMgr_isBridgeInstalled = self.mDllHandle.SDAppInteropMgr_isBridgeInstalled
        self.SDAppInteropMgr_isBridgeInstalled.restype = ctypes.c_int
        self.SDAppInteropMgr_isBridgeInstalled.argtypes = [ctypes.c_void_p, ctypes.POINTER(ctypes.c_bool)]
        self.SDAppInteropMgr_isStagerInstalled = self.mDllHandle.SDAppInteropMgr_isStagerInstalled
        self.SDAppInteropMgr_isStagerInstalled.restype = ctypes.c_int
        self.SDAppInteropMgr_isStagerInstalled.argtypes = [ctypes.c_void_p, ctypes.POINTER(ctypes.c_bool)]
        self.SDAppInteropMgr_saveSBSBeforePublishingOrSending = self.mDllHandle.SDAppInteropMgr_saveSBSBeforePublishingOrSending
        self.SDAppInteropMgr_saveSBSBeforePublishingOrSending.restype = ctypes.c_int
        self.SDAppInteropMgr_saveSBSBeforePublishingOrSending.argtypes = [ctypes.c_void_p, ctypes.POINTER(ctypes.c_bool)]
        self.SDAppInteropMgr_publishSBSARWithProgressDialog = self.mDllHandle.SDAppInteropMgr_publishSBSARWithProgressDialog
        self.SDAppInteropMgr_publishSBSARWithProgressDialog.restype = ctypes.c_int
        self.SDAppInteropMgr_publishSBSARWithProgressDialog.argtypes = [ctypes.c_void_p, ctypes.c_char_p, ctypes.c_char_p, ctypes.c_int]
        self.SDAppInteropMgr_sendPackageToSampler = self.mDllHandle.SDAppInteropMgr_sendPackageToSampler
        self.SDAppInteropMgr_sendPackageToSampler.restype = ctypes.c_int
        self.SDAppInteropMgr_sendPackageToSampler.argtypes = [ctypes.c_void_p, ctypes.c_void_p]
        self.SDAppInteropMgr_sendPackageToPainter = self.mDllHandle.SDAppInteropMgr_sendPackageToPainter
        self.SDAppInteropMgr_sendPackageToPainter.restype = ctypes.c_int
        self.SDAppInteropMgr_sendPackageToPainter.argtypes = [ctypes.c_void_p, ctypes.c_void_p]
        self.SDAppInteropMgr_sendPackageToStager = self.mDllHandle.SDAppInteropMgr_sendPackageToStager
        self.SDAppInteropMgr_sendPackageToStager.restype = ctypes.c_int
        self.SDAppInteropMgr_sendPackageToStager.argtypes = [ctypes.c_void_p, ctypes.c_void_p]
        self.SDAppInteropMgr_sendPackageToPlayer = self.mDllHandle.SDAppInteropMgr_sendPackageToPlayer
        self.SDAppInteropMgr_sendPackageToPlayer.restype = ctypes.c_int
        self.SDAppInteropMgr_sendPackageToPlayer.argtypes = [ctypes.c_void_p, ctypes.c_void_p]
        self.SDAppInteropMgr_showPackageInBridge = self.mDllHandle.SDAppInteropMgr_showPackageInBridge
        self.SDAppInteropMgr_showPackageInBridge.restype = ctypes.c_int
        self.SDAppInteropMgr_showPackageInBridge.argtypes = [ctypes.c_void_p, ctypes.c_void_p]
        self.SDAppInteropMgr_showResourceInBridge = self.mDllHandle.SDAppInteropMgr_showResourceInBridge
        self.SDAppInteropMgr_showResourceInBridge.restype = ctypes.c_int
        self.SDAppInteropMgr_showResourceInBridge.argtypes = [ctypes.c_void_p, ctypes.c_void_p]
        self.SDAppInteropMgr_resendPackage = self.mDllHandle.SDAppInteropMgr_resendPackage
        self.SDAppInteropMgr_resendPackage.restype = ctypes.c_int
        self.SDAppInteropMgr_resendPackage.argtypes = [ctypes.c_void_p, ctypes.c_void_p]
        self.SDAppInteropMgr_hasPackageBeenSent = self.mDllHandle.SDAppInteropMgr_hasPackageBeenSent
        self.SDAppInteropMgr_hasPackageBeenSent.restype = ctypes.c_int
        self.SDAppInteropMgr_hasPackageBeenSent.argtypes = [ctypes.c_void_p, ctypes.c_void_p, ctypes.POINTER(ctypes.c_bool)]
        self.SDAppInteropMgr_updateSentToHistory = self.mDllHandle.SDAppInteropMgr_updateSentToHistory
        self.SDAppInteropMgr_updateSentToHistory.restype = ctypes.c_int
        self.SDAppInteropMgr_updateSentToHistory.argtypes = [ctypes.c_void_p]
        self.SDAppInteropMgr_getLastErrorMessage = self.mDllHandle.SDAppInteropMgr_getLastErrorMessage
        self.SDAppInteropMgr_getLastErrorMessage.restype = ctypes.c_int
        self.SDAppInteropMgr_getLastErrorMessage.argtypes = [ctypes.c_void_p, ctypes.POINTER(ctypes.c_char_p)]
        self.mTypeMap['SDAppInteropMgr'] = SDAppInteropMgr
        from .sdgraphpresetinput import SDGraphPresetInput
        self.SDGraphPresetInput_getIdentifier = self.mDllHandle.SDGraphPresetInput_getIdentifier
        self.SDGraphPresetInput_getIdentifier.restype = ctypes.c_int
        self.SDGraphPresetInput_getIdentifier.argtypes = [ctypes.c_void_p, ctypes.POINTER(ctypes.c_char_p)]
        self.SDGraphPresetInput_getValue = self.mDllHandle.SDGraphPresetInput_getValue
        self.SDGraphPresetInput_getValue.restype = ctypes.c_int
        self.SDGraphPresetInput_getValue.argtypes = [ctypes.c_void_p, ctypes.POINTER(ctypes.c_void_p)]
        self.SDGraphPresetInput_setValue = self.mDllHandle.SDGraphPresetInput_setValue
        self.SDGraphPresetInput_setValue.restype = ctypes.c_int
        self.SDGraphPresetInput_setValue.argtypes = [ctypes.c_void_p, ctypes.c_void_p]
        self.mTypeMap['SDGraphPresetInput'] = SDGraphPresetInput
        from .sbs.sdsbscompgraphpreset import SDSBSCompGraphPreset
        self.SDSBSCompGraphPreset_getLabel = self.mDllHandle.SDSBSCompGraphPreset_getLabel
        self.SDSBSCompGraphPreset_getLabel.restype = ctypes.c_int
        self.SDSBSCompGraphPreset_getLabel.argtypes = [ctypes.c_void_p, ctypes.POINTER(ctypes.c_char_p)]
        self.SDSBSCompGraphPreset_getUserTags = self.mDllHandle.SDSBSCompGraphPreset_getUserTags
        self.SDSBSCompGraphPreset_getUserTags.restype = ctypes.c_int
        self.SDSBSCompGraphPreset_getUserTags.argtypes = [ctypes.c_void_p, ctypes.POINTER(ctypes.c_char_p)]
        self.SDSBSCompGraphPreset_setUserTags = self.mDllHandle.SDSBSCompGraphPreset_setUserTags
        self.SDSBSCompGraphPreset_setUserTags.restype = ctypes.c_int
        self.SDSBSCompGraphPreset_setUserTags.argtypes = [ctypes.c_void_p, ctypes.c_char_p]
        self.SDSBSCompGraphPreset_getInputs = self.mDllHandle.SDSBSCompGraphPreset_getInputs
        self.SDSBSCompGraphPreset_getInputs.restype = ctypes.c_int
        self.SDSBSCompGraphPreset_getInputs.argtypes = [ctypes.c_void_p, ctypes.POINTER(ctypes.c_void_p)]
        self.SDSBSCompGraphPreset_addInput = self.mDllHandle.SDSBSCompGraphPreset_addInput
        self.SDSBSCompGraphPreset_addInput.restype = ctypes.c_int
        self.SDSBSCompGraphPreset_addInput.argtypes = [ctypes.c_void_p, ctypes.c_char_p, ctypes.c_void_p, ctypes.POINTER(ctypes.c_void_p)]
        self.mTypeMap['SDSBSCompGraphPreset'] = SDSBSCompGraphPreset
