...
class SDResourceFont(SDResource):
    ...
    def __init__(self, APIContext, handle, *args, **kwargs):
        ...
        """
        super(SDResourceFont, self).__init__(APIContext, handle, *args, **kwargs)

    @staticmethod
    def sNewFromFile(parent : SDAPIObject, filePath : str, embedMethod : EmbedMethod) -> SDResourceFont:
        """
